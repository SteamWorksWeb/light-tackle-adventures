    ...
    <>
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <span className="text-[#FA4616] font-bold tracking-widest text-sm uppercase">The Proof</span>
          ...
          <p className="text-xl text-slate-300 mt-4 max-w-2xl leading-relaxed">
            Real fish, real water, real moments — from the Nature Coast flats with Capt. Jim Lemke.
          </p>
        </div>
      </section>
      ...
      <div className="bg-slate-50 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="mt-16 text-center">
            <p className="text-slate-500 text-base mb-6">Ready to create your own memories on the Nature Coast?</p>
            <Link
              href="/reservations"
      ...
      <div
        className={`fixed inset-0 z-[100] flex items-center justify-center bg-black/95 p-4 cursor-zoom-out transition-all duration-[420ms] ease-in-out ${
      ...
      >
        ...
        {/* Prev */}
        <button
          className="absolute left-3 md:left-6 text-white bg-white/10 hover:bg-[#FA4616] rounded-full p-3 transition-all duration-200 z-10"
          onClick={prev}
        ...
        {/* Next */}
        <button
          className="absolute right-3 md:right-6 text-white bg-white/10 hover:bg-[#FA4616] rounded-full p-3 transition-all duration-200 z-10"
          onClick={next}
        ...
        {activeImage && (
          <>
            ...
            <div
              className={`relative w-full max-w-6xl aspect-video transform transition-all duration-[700ms] ease-out ${
            ...
            <div className="absolute bottom-5 left-0 right-0 flex flex-col items-center gap-1 pointer-events-none">
              <p className="text-slate-300 text-sm px-4 text-center">{activeImage.alt}</p>
              <p className="text-slate-500 text-xs">{activeIndex + 1} / {filtered.length}</p>
            </div>
          </>
        )}
      </div>
