  ...
  return (
    <div className="bg-slate-50 min-h-screen pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-4 prose prose-lg prose-slate">
        ...
        <h1>Sea Trout Fishing on the Nature Coast</h1>
        ...
        <p>
          ...
          productive Trout habitats in Florida.
        </p>
        <p>
          These flats support large populations of slot-size fish alongside
          occasional trophy &ldquo;Gator Trout&rdquo; pushing 30 inches or
          more. Hard-fighting and excellent table fare, Sea Trout are accessible
        ...
        <p>
          As the water warms in spring, they spread across the shallow flats
          and become highly catchable on topwater lures during the early morning
          hours.
        </p>

        <h2>Tactics and Gear</h2>
        <p>
          When pursuing Sea Trout, we utilize premium light spinning tackle and
          tournament-grade fly gear to ensure the best possible presentation and
          fight. Live shrimp under a popping cork is the most reliable producer
          across all conditions.
        </p>
        <p>
          Paddle tail jigs in natural colors and topwater walk-the-dog plugs
          produce explosive strikes in shallow water during low-light periods.
          On fly, a slow-sinking Clouser or EP Shrimp pattern worked through a
          grass flat at first light is a highly enjoyable approach.
        </p>
