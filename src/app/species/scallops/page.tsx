    ...
    <div className="bg-slate-50 min-h-screen pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-4 prose prose-lg prose-slate">
        ...
        <p>
          ...
          Gulf&apos;s bay scallops, recognizable by their vivid blue eyes and
          distinctive fan-shaped shells, thrive in the lush seagrass beds of
          Citrus and Levy Counties, making this one of the most productive
          and enjoyable harvest fisheries in the state. Capt. Jim&apos;s
          scalloping charters are the perfect family adventure — no fishing
          experience required, just enthusiasm and a willingness to get wet.
        </p>
        ...
        <p>
          ...
          anchor the boat, and everyone goes in the water together. Scallops
          are found resting on and just above the seagrass bottom in 3 to 8
          feet of crystal-clear water, making them easy to spot and fun to
          collect. At the end of the trip, Capt. Jim can clean and shuck your
          scallops dockside so you leave with a cooler full of fresh,
          sweet bay scallop meat ready for the dinner table. Bag limits of
          2 gallons of whole scallops or 1 pint of meat per person apply
