      ...
      >
        ...
        <div className="w-full px-6 py-2 flex justify-between items-center border-b border-white/10">
          ...
          <div className="hidden md:flex items-center gap-4">
            {/* Instagram */}
            <a href="https://www.instagram.com/captjimlemke" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-slate-400 hover:text-[#FA4616] transition-colors duration-200">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/jim.lemke.37" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-slate-400 hover:text-[#FA4616] transition-colors duration-200">
